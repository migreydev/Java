...
public class ejercicio6 {
	...
	public static void main(String[] args) {
		...
		System.out.println(horaMayor(tiempo1,tiempo2));
	}
	
	public static int horaMayor(int tiempo1, int tiempo2) {
		int mensaje=0;
		int contador=0;
		
		while ((tiempo1 >0 && tiempo2>0) && (contador <1)){
			if (tiempo1 > tiempo2) {
				mensaje=1;
				contador ++;
				
			}else if (tiempo2 < tiempo2) {
				mensaje=2;
				contador ++;
